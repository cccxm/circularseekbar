...
public class CircularSeekBar extends View {
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        mProgressOffset = attrArray.getInt(R.styleable.CircularSeekBar_progressOffset, mProgressOffset);
        isTouchEnabled = attrArray.getBoolean(R.styleable.CircularSeekBar_touchEnable, isTouchEnabled);
    ...
    protected void initPaths() {
        ...
        mCircleProgressPath.addArc(mCircleRectF, mStartAngle + mProgressOffset, mProgressDegrees);
    }
     ...
     * 设置绘制进度条的起点偏移量
     */
    public void setProgressOffset(int offset) {
